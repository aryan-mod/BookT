...
import { X, Star, Clock, BookOpen, Heart, MessageCircle, Share2, ChevronLeft, ChevronRight, Quote } from 'lucide-react';
import { gsap } from 'gsap';

const BookModal = ({ book, isOpen, onClose, onReactionClick }) => {
                ...
                <div className="flex flex-wrap gap-2">
                  {availableEmojis.map((emoji) => (
                    <button
                      ...
                      className={`emoji-${emoji} p-2 rounded-full border-2 transition-all duration-200 hover:scale-110 ${
